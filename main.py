...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='p2t_small', type=str, metavar='MODEL',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('P2T training and evaluation script', parents=[get_args_parser()])
